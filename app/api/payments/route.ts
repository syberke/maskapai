...
export async function POST(request: Request) {
  try {
    ...
    // 1. Ambil data booking lengkap dengan relasi User dan Penerbangan
    ...
    const parameter = {
      transaction_details: {
        order_id: `RENGGO-${booking.bookingCode}-${Date.now()}`, // Gabungan kode unik biar tidak membentur order_id lama
